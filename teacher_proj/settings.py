"""
Django settings for teacher_proj project.
...
SECRET_KEY = 'django-insecure-bv=vi=$)=$k*ov0a)*)6k*h_d*2bbnip($37dn!d%$5s_@dqcg'
...
INSTALLED_APPS = [
    ...
    'acad_audit.apps.AcadAuditConfig',    
    'widget_tweaks',
    'django_filters',
...
ROOT_URLCONF = 'teacher_proj.urls'
...
WSGI_APPLICATION = 'teacher_proj.wsgi.application'
